<template>
  <div class="drawer fixed top-0 w-full lg:relative lg:h-16" :class="[{'z-20 h-screen': drawerOpen}, {'z-20 h-16': !drawerOpen}]">
    <input id="my-drawer-3" type="checkbox" v-model="drawerOpen" class="drawer-toggle">
    <div class="drawer-content">
      <div class="navbar mb-2 shadow-lg bg-neutral text-neutral-content ">
        ...
        <div class="navbar-end">
          <a href="https://github.com/nitocode/vue3-roulette" target="_blank" class="btn btn-square btn-ghost">
    ...
    <div class="drawer-side">
      ...
      <ul class="p-4 overflow-y-auto menu w-80 bg-base-100">
        <li>
          <router-link to="/" @click="drawerOpen = false"><a>Home</a></router-link>
        </li> 
        <li>
          <router-link to="/docs" @click="drawerOpen = false"><a>Docs</a></router-link>
        </li>
        <li>
          <router-link to="/examples" @click="drawerOpen = false"><a>Have fun</a></router-link>
        </li>
      </ul>
    </div>
  </div>
